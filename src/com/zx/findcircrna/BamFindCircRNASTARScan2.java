...
public class BamFindCircRNASTARScan2 extends FindCircRNASTARScan2 {
	public BamFindCircRNASTARScan2(int minMapqUni, HashMap<String, Integer> circFSJMap, int linear_range_size_min,
