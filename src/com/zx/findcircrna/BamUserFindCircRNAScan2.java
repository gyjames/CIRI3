...
public class BamUserFindCircRNAScan2  extends UserFindCircRNAScan2  {

	public BamUserFindCircRNAScan2(int minMapqUni, HashMap<String, Integer> circFSJMap, int linear_range_size_min,
