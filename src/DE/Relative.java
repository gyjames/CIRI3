...
public class Relative {
	...
	ArrayList<String> caseSampleList = new ArrayList<String>();
	ArrayList<String> controlSampleList = new ArrayList<String>();
	...
	while (line != null) {
		...
		if (arr[2].equals("Case")) {
			caseSampleList.add(arr[0]);
		}else {					
			controlSampleList.add(arr[0]);				
		}
